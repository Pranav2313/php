...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="doctorhome.php">C&C Medical Center</a></h1>
      <!-- <a href="index.html" class="logo me-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="doctorhome.php">Home</a></li>
          ...
          <li><a class="nav-link scrollto" href="appointments.php">Manage Appointments</a></li>	
			...
			<li><a class="nav-link scrollto" href="profile.php">Edit Profile</a></li>	<li><a class="nav-link scrollto" href="doctorfeedback.php">Feedback</a></li>
        </ul>
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              ...
              We provide the solution for all of your medical needs. We provide you with the best doctors and medical officers.
              </p>
              <div class="text-center">
                <a href="doctorfeedback.php" class="more-btn">Feedback<i class="bx bx-chevron-right"></i></a>
              </div>
            </div>
          </div>
...
<?php
   ...
   echo"hello";
	  ...
	  $aq="select count(*) from appointment where doctorid='$doctorid' and status in ('pending','confirmed') ";
