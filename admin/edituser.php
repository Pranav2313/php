...
<?php
  ...
  <main id="main">
	...
	<?php 
	  ...
	  if($user=="patient")
	  {
		  $qry="select * from patients where UserID = '$id'";
	$sql=mysqli_fetch_array(mysqli_query($conn,$qry));
	  ?>	
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<label>Email</label>&nbsp;&nbsp;&nbsp;
					<input type="email" name="email" value="<?php echo $sql[4]?>" required=""/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<label>Number [10 digits]</label>&nbsp;&nbsp;&nbsp;&nbsp;
			<input  style="width: 30%;" type="tel" pattern="^\d{10}$"  name="number" value="<?php echo $sql[3]?>" required="" />
			<br><br>
			<button type="submit" name="updatepatient" style="border-radius: 20px;
...
<?php }
				...
				$qry="select * from doctor where doctorid = '$id'";
	$sql=mysqli_fetch_array(mysqli_query($conn,$qry));
	  ...
	  <form action="profileupdate.php" method="post">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<button type="submit" name="updatedoctor" style="border-radius: 20px;border: 1px solid #FFFFFF;
	background-color: #1977cc;
	color: #ffffff;
	font-size: 12px;
	font-weight: bold;
